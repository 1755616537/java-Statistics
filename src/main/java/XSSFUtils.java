...
//            newDLbls.setShowLeaderLines(ctBoolean);
    ...
    /**
     * create CTPlotArea
     * @param params          int[]{startCol, startRow, endCol, endRow,
